...
Plugin skills are namespaced and do **not** shadow — same-name skills coexist across plugins. To make `/mattpocock:bdd`, `/mattpocock:implement`, etc. unambiguous, disable the installed `mattpocock-skills` plugin:
