...
- **Closeout**: `references/closeout.md` - Summary comment template, PR title/body rewrite, merge decision via AskUserQuestion, post-merge base-branch sync, idempotency and ordering
