...
**Active plugins:** git, gitflow, github, refactor, swiftui, office, plugin-optimizer, superdev, antigravity
...
**Scopes:** acpx, ag, as, cctx, fe, git, gitflow, github, hw, marketing, office, po, refactor, sd, storm, swiftui, utils
