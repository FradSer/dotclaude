...
**Active plugins:** git, gitflow, github, refactor, swiftui, office, plugin-optimizer, superpowers, antigravity
...
**Scopes:** acpx, ag, as, cctx, fe, git, gitflow, github, hw, marketing, office, po, refactor, sp, storm, swiftui, utils
