...
- 待办任务管理 → 使用 [`lark-task`](../lark-task/lark-task.md)
- 日程安排 → 使用 [`lark-calendar`](../lark-calendar/lark-calendar.md)
- 绩效评估 → 使用 [`lark-openapi-explorer`](../lark-openapi-explorer/lark-openapi-explorer.md) 查找原生接口
