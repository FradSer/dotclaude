...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, driving `/superdev:bdd` at pre-agreed seams and closing out with `/superdev:code-review` before committing.
