...
Under marketing/skills/ only the root router SKILL.md and hyperframes/SKILL.md
should be discoverable; upstream sub-skills ship as <dirname>/SKILL.md and must
be renamed after sync to <dirname>/<dirname>.md. Relative links are rewritten
to match.

Also handles the hyperframes sub-tree: hyperframes/<sub>/SKILL.md →
hyperframes/<sub>/<sub>.md, while keeping hyperframes/SKILL.md as the router.
